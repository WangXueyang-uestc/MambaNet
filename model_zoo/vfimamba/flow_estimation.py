...
class MultiScaleFlow(nn.Module):
    def __init__(self, backbone, **kargs):
        ...
        self.unet = Unet(kargs['c'] * 2, kargs['M'], out=9)
    ...
    def forward(self, x, local=False, timestep=0.5, scale=0):
        ...
        pred0 = torch.clamp(img0 + res0, 0, 1)
        pred1 = torch.clamp(img1 + res1, 0, 1)
        
        return flow_list, mask_list, merged, pred, pred0, pred1